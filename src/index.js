...
function dataHandler(json) {
  ...
  dataOutputs1[1].value = city;
  dataOutputs1[3].value = `${coords[0]}, ${coords[1]}`;
  dataOutputs1[5].value = pm25;
  dataOutputs2[1].value = pm10;
  dataOutputs2[3].value = aqi;
  dataOutputs2[5].value = uvi;
...
async function getCityPollution(city) {
  ...
  if(response.status == 200 && result.status == 'ok') {
    ...
    dataOutputs1[3].value = '';
    dataOutputs1[5].value = '';
    dataOutputs2[1].value = '';
    dataOutputs2[3].value = '';
    dataOutputs2[5].value = '';
...
getCity.onclick = async () => {
  let tempCity = cityInput.value;
  if (!tempCity) {
    emptyFields(cityInput);
  } else {
    await getCityPollution(tempCity);
    coordInput[0].value = '';
    coordInput[1].value = '';
